...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', '', 3000, '.main-prev-btn', '.main-next-btn');
...
/* harmony default export */ __webpack_exports__["default"] = (accordion); //  blocks.forEach(block => {
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (materialBlock.value == '' || optionsBlock.value == '') {
      resultBlock.textContent = 'Виберіть параметри і маткеріали';
...
var drops = function drops() {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      input.files = e.dataTransfer.files; //чтобы была возможность редактировать файл
...
var filter = function filter() {
  ...
  menu.addEventListener('click', function (e) {
    var itemClass = e.target.classList[0];
    var markElems = wrapper.querySelectorAll(".".concat(itemClass));
...
var forms = function forms() {
  var form = document.querySelectorAll('form'),
      ...
      option = document.querySelectorAll('option'); // checkNumInputs('input[name="user_phone"]');
  ...
  var clearInputs = function clearInputs() {
    ...
    upload.forEach(function (item) {
      item.previousElementSibling.textContent = 'Фацй не выбран';
    });
  };
  ...
  var state = {};
  option.forEach(function (item, num) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      statusImg.classList.add('animation', 'fadeInUp');
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    function openModal() {
      windows.forEach(function (item) {
        item.style.display = 'none';
        item.classList.add('animated', 'swing');
      });
  ...
  showModalByTime('.popup-consultation', 60000000);
};
    ...
    link.addEventListener('click', function (e) {
      ...
      function step(time) {
        ...
        if (r != widthTop + toBlock) {
          //когда будет ровна сума = долистали до нужного элем
          requestAnimationFrame(step);
        } else {
          location.hash = hash;
        }
...
var showMoreStyle = function showMoreStyle(trigger, wrapper) {
  var btn = document.querySelector(trigger); // btn.addEventListener('click', () => {
  //     cards.forEach(card => {
...
var sliders = function sliders(slides, direction, time, prev, next) {
  var slideIndex = 1,
      paused = false;
